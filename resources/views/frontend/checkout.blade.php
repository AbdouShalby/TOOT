                ...
                <div class="col-lg-8 mx-auto">
                    <form class="form-default" data-toggle="validator" action="{{ route('payment.checkout') }}" role="form" method="POST" id="checkout-form">
                        ...
                        <div class="accordion" id="accordioncCheckoutInfo">
                            ...
                            <div class="card rounded-0 border shadow-none" style="margin-bottom: 2rem; overflow: visible !important;">
                                <div class="card-body">
                                    <h5 class="fw-700">{{ translate('Design Options') }}</h5>

                                    <!-- Design Option Radio Buttons -->
                                    <div class="form-group">
                                        <label>
                                            <input type="radio" name="design_option" value="upload" checked onchange="toggleDesignOption(this)">
                                            {{ translate('Upload Custom Design') }}
                                        </label>
                                        <br>
                                    ...
                                    <div class="form-group mt-3">
                                        <label>
                                            <input type="radio" name="design_option" value="custom" onchange="toggleDesignOption(this)">
                                            {{ translate('Request Custom Design') }}
                                        </label>
                                        <br>
                                        <textarea name="custom_design_request" id="custom_design_request" class="form-control" placeholder="{{ translate('Describe your design requirements...') }}"></textarea>
                                    </div>
                                </div>
                            </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function toggleDesignOption(option) {
            const uploadFileInput = document.getElementById('upload_file');
            const customDesignInput = document.getElementById('custom_design_request');

            if (option.value === 'upload') {
                uploadFileInput.style.display = 'block';
                customDesignInput.style.display = 'none';
            } else {
                uploadFileInput.style.display = 'none';
                customDesignInput.style.display = 'block';
            }
        }

        document.getElementById('custom_design_request').style.display = 'none';
    </script>
