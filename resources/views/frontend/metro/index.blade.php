                ...
                <div class="bg-white px-sm-3">
                    <div class="d-flex flex-wrap justify-content-center align-items-center gap-3">
                        @foreach ($featured_categories as $key => $category)
                            ...
                            @endphp
                            <a href="{{ route('products.category', $category->slug) }}" class="category-box text-center border rounded overflow-hidden mx-2 text-decoration-none" style="width: 100px; height: auto; color: inherit;">
                                <div style="width: 100%; height: 100px; overflow: hidden;">
                                    <img src="{{ isset($category->coverImage->file_name) ? my_asset($category->coverImage->file_name) : static_asset('assets/img/placeholder.jpg') }}"
                                        alt="{{ $category_name }}"
                                        class="img-fit w-75 h-75"
                                        onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                                </div>
                                <div class="text-dark fw-bold fs-12 text-truncate mt-2">
                                    {{ $category_name }}
                                </div>
                            </a>
                        @endforeach
